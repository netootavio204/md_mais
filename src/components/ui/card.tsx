...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-slate-800/80 bg-slate-900/80 text-slate-100 shadow-2xl backdrop-blur-xl transition-all duration-300 hover:border-slate-700/80",
      className
    )}
    {...props}
  />
